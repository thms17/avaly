...
(() => {
  if (!document.body?.matches('[page="home"]')) return;
  ...
  function loadVideo(videoContainer, players, index) {
    ...
    webmSource.src = 'https://files.theavaly.com/Homepage-Video.webm';
    webmSource.type = 'video/webm';

    const mp4Source = document.createElement('source');
    mp4Source.src = 'https://files.theavaly.com/Homepage-Video.mp4';
